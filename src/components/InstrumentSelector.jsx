  ...
  return (
    <>
      <Button
        ...
        variant="outline"
        colorScheme="primary"
        leftIcon={<span role="img" aria-label="Instrument">🎹</span>}
        onClick={onOpen}
      >
        Instruments
      </Button>
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered size="md">
        ...
        <ModalContent bg="rgba(30, 41, 59, 0.95)" borderColor="rgba(255, 255, 255, 0.1)" boxShadow="0 4px 12px rgba(0, 0, 0, 0.5)">
